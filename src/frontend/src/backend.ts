...
import type { Type as _Type, UserProfile as _UserProfile, UserRole as _UserRole, UserRole__1 as _UserRole__1 } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createListing(arg0: Listing): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getDemoListings(): Promise<Array<Listing>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDemoListings();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFilteredListings(arg0: Type): Promise<Array<Listing>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFilteredListings(to_candid_Type_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getListingBids(arg0: string): Promise<Array<Bid>> {
        if (this.processError) {
            try {
                const result = await this.actor.getListingBids(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeBid(arg0: Bid): Promise<void> {
        if (this.processError) {
            try {
    ...
    async registerUser(arg0: UserProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.registerUser(to_candid_UserProfile_n12(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        userRole: from_candid_UserRole_n6(_uploadFile, _downloadFile, value.userRole),
        userId: value.userId,
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "sellerDealer" in value ? UserRole.sellerDealer : "businessBuyer" in value ? UserRole.businessBuyer : value;
}
...
function to_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        userRole: to_candid_UserRole_n14(_uploadFile, _downloadFile, value.userRole),
        userId: value.userId,
        createdAt: value.createdAt,
        businessName: value.businessName,
        mobileNumber: value.mobileNumber,
...
function to_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Type): {
    ...
    return value == Type.allListings ? {
        allListings: null
    } : value == Type.liveListings ? {
        liveListings: null
    } : value == Type.sevenDayListings ? {
        sevenDayListings: null
    } : value;
}
function to_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: UserRole): {
    ...
    return value == UserRole.sellerDealer ? {
        sellerDealer: null
